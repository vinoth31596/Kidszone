...
class EditCustomCell: UITableViewCell ,UIPickerViewDelegate, UIPickerViewDataSource{
    
    @IBOutlet weak var deleteBtn: UIButton!
    var myTabelController: EditRegistrationViewController?
    ...
    @IBAction func deleteRow(_ sender: UIButton) {
        ...
        myTabelController?.deleteCell1(cell: self)
    }
...
extension EditCustomCell:  UIImagePickerControllerDelegate, UINavigationControllerDelegate{
