...
public class ModernSearchBarCell: UITableViewCell {
    ...
    public func configureConstraints(heightImage: CGFloat, widthImage: CGFloat){
        ...
        leftImageConstraint.priority = UILayoutPriority.defaultLow
        ...
        topLabelConstraint.priority = UILayoutPriority.defaultLow
        ...
        bottomLabelConstraint.priority = UILayoutPriority.defaultLow
...
//            }
    ...
    public func configureWidthMaxLabel(suggestionsViewWidth: CGFloat, searchImageWidth: CGFloat) {
        ...
        widthMax = widthMax - (ModernSearchBarCell.defaultMargin * 3)
        widthMax = widthMax - searchImageWidth
